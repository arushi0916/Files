...
<html>
<head>
<title>Agent Show Claim List</title>
...
<div class="table-div">
	...
	<table>
	<form action="agentSearchBasedOnFilter" method="post" onsubmit="return defaultAccount()">
		  <tr><td><input type="text" placeholder="Account Number" class="input-edit-searchbox" name="accountNumber"  id="accountNumber"></td>
		 
		   
		   	<td><select class="input-edit filter" onchange="filter()" name="filter" required>
